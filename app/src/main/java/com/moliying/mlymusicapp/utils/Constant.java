...
public class Constant {
    ...
    public static final String SP_NAME = "mly_sp";  //私有属性文件名
    public static final String DB_NAME = "mly_music.db"; //数据库名
    public static final int VERSION = 2; //数据库版本
    public static final int PLAY_RECORD_NUM = 30;//最近播放显示的最大条数
...
//    Locale
    ...
    //音乐路径
    public static final String DIR_MLY_MUSIC = "/mly_music/music";
